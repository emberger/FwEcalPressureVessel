...
//=========  (Fri Dec  8 23:47:29 2017) by ROOT version5.34/36
   ...
   graph->SetPoint(0,50,0.5273578947);
   graph->SetPoint(1,150,0.2697222222);
   graph->SetPoint(2,250,0.2009);
   graph->SetPoint(3,350,0.1718243243);
   graph->SetPoint(4,450,0.1583536585);
   graph->SetPoint(5,550,0.1360752688);
   graph->SetPoint(6,650,0.1290291262);
   graph->SetPoint(7,750,0.12);
   graph->SetPoint(8,850,0.1113247863);
   graph->SetPoint(9,950,0.1074615385);
   graph->SetPoint(10,1500,0.08361111111);
   ...
   graph->SetMarkerSize(1.5);
   graph->SetPoint(0,50,0.4380976744);
   graph->SetPoint(1,150,0.214122807);
   graph->SetPoint(2,250,0.1641025641);
   graph->SetPoint(3,350,0.1380952381);
   graph->SetPoint(4,450,0.117366);
   graph->SetPoint(5,550,0.1076838235);
   graph->SetPoint(6,650,0.09876666667);
   graph->SetPoint(7,750,0.092734375);
   graph->SetPoint(8,850,0.08743670886);
   graph->SetPoint(9,950,0.08146496815);
   graph->SetPoint(10,1500,0.06645);
   
   TH1F *Graph_Graph8 = new TH1F("Graph_Graph8","Res_68Quantile_PCA",100,0,1645);
   Graph_Graph8->SetMinimum(0.02928523);
   Graph_Graph8->SetMaximum(0.4752624);
   ...
   graph->SetMarkerStyle(24);
   graph->SetMarkerSize(1.5);
   graph->SetPoint(0,50,0.5508916667);
   graph->SetPoint(1,150,0.2734043478);
   graph->SetPoint(2,250,0.2090833333);
   graph->SetPoint(3,350,0.175915493);
   graph->SetPoint(4,450,0.1568518519);
   graph->SetPoint(5,550,0.1416470588);
   graph->SetPoint(6,650,0.1291726619);
   graph->SetPoint(7,750,0.1205042017);
   graph->SetPoint(8,850,0.1119343066);
   graph->SetPoint(9,950,0.1071212121);
   graph->SetPoint(10,1500,0.085);
   
   TH1F *Graph_Graph9 = new TH1F("Graph_Graph9","Res_68Quantile_PCA",100,0,1645);
   Graph_Graph9->SetMinimum(0.03841083);
   Graph_Graph9->SetMaximum(0.5974808);
   ...
   graph->SetMarkerStyle(20);
   graph->SetMarkerSize(1.5);
   graph->SetPoint(0,50,0.6310888889);
   graph->SetPoint(1,150,0.3120238095);
   graph->SetPoint(2,250,0.24);
   graph->SetPoint(3,350,0.1968461538);
   graph->SetPoint(4,450,0.179765625);
   graph->SetPoint(5,550,0.162);
   graph->SetPoint(6,650,0.1514210526);
   graph->SetPoint(7,750,0.1409375);
   graph->SetPoint(8,850,0.1319230769);
   graph->SetPoint(9,950,0.1255208333);
   graph->SetPoint(10,1500,0.1005194805);
   
   TH1F *Graph_Graph10 = new TH1F("Graph_Graph10","Res_68Quantile_PCA",100,0,1645);
   Graph_Graph10->SetMinimum(0.04746254);
   Graph_Graph10->SetMaximum(0.6841458);
