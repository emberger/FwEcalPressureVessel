{
        TFile * f1= new TFile("~/Geant4/Data/ForwardEcalWithPressureVessel/AngularResolution/AngReso_IT20_OT20_40Inner_50Outer_lead1mm_Polystyrene5mm_14mmTitanVessel/Analysis/ROOT/LogE_Res_PCA_68Quantil.root");
        TCanvas * c1=(TCanvas*)f1->Get("c2p");
        TGraph * g1=(TGraph*)c1->GetListOfPrimitives()->Last();


        TFile * f2= new TFile("~/Geant4/Data/ForwardEcalWithPressureVessel/AngularResolution/AngReso_IT20_OT20_40Inner_50Outer_lead2mm_Polystyrene5mm_14mmTitanVessel/Analysis/ROOT/LogE_Res_PCA_68Quantil.root");
        TCanvas * c2=(TCanvas*)f2->Get("c2p");
        TGraph * g2=(TGraph*)c2->GetListOfPrimitives()->Last();

        TFile * f3= new TFile("~/Geant4/Data/ForwardEcalWithPressureVessel/AngularResolution/AngReso_IT20_OT20_40Inner_50Outer_lead1mm_Polystyrene5mm_20mmSteelVessel/Analysis/ROOT/LogE_Res_PCA_68Quantil.root");
        TCanvas * c3=(TCanvas*)f3->Get("c2p");
        TGraph * g3=(TGraph*)c3->GetListOfPrimitives()->Last();

        TFile * f4= new TFile("~/Geant4/Data/ForwardEcalWithPressureVessel/AngularResolution/AngReso_IT20_OT20_40Inner_50Outer_lead2mm_Polystyrene5mm_20mmSteelVessel/Analysis/ROOT/LogE_Res_PCA_68Quantil.root");
        TCanvas * c4=(TCanvas*)f4->Get("c2p");
        TGraph * g4=(TGraph*)c4->GetListOfPrimitives()->Last();
/*
        TFile * f5= new TFile("AngReso_IT20_OT20_40Inner_50Outer_lead2mm_Polystyrene5mm_20mmSteelVessel/Analysis/ROOT/ResPCA_68Quantil.root");
...
*/
        ...
        TFile * f5= new TFile("~/Geant4/Data/ForwardEcalWithPressureVessel/AngularResolution/AngReso_IT20_OT20_25Inner_50Outer_lead1mm_Polystyrene5mm_14mmTitanVessel/Analysis/ROOT/LogE_Res_PCA_68Quantil.root");
        TCanvas * c5=(TCanvas*)f5->Get("c2p");
        TGraph * g5=(TGraph*)c5->GetListOfPrimitives()->Last();


        TFile * f6= new TFile("~/Geant4/Data/ForwardEcalWithPressureVessel/AngularResolution/AngReso_IT20_OT20_25Inner_50Outer_lead2mm_Polystyrene5mm_14mmTitanVessel/Analysis/ROOT/LogE_Res_PCA_68Quantil.root");
        TCanvas * c6=(TCanvas*)f6->Get("c2p");
        TGraph * g6=(TGraph*)c6->GetListOfPrimitives()->Last();

        TFile * f7= new TFile("~/Geant4/Data/ForwardEcalWithPressureVessel/AngularResolution/AngReso_IT20_OT20_25Inner_50Outer_lead1mm_Polystyrene5mm_20mmSteelVessel/Analysis/ROOT/LogE_Res_PCA_68Quantil.root");
        TCanvas * c7=(TCanvas*)f7->Get("c2p");
        TGraph * g7=(TGraph*)c7->GetListOfPrimitives()->Last();

        TFile * f8= new TFile("~/Geant4/Data/ForwardEcalWithPressureVessel/AngularResolution/AngReso_IT20_OT20_25Inner_50Outer_lead2mm_Polystyrene5mm_20mmSteelVessel/Analysis/ROOT/LogE_Res_PCA_68Quantil.root");
        TCanvas * c8=(TCanvas*)f8->Get("c2p");
        TGraph * g8=(TGraph*)c8->GetListOfPrimitives()->Last();
//Standard is 1cm Lead, NO Vessel
	...
	rat8->Draw("P");
        ...
        ratio1->Print("GeometryRating_AngleDiff_LogEweight_25-40Layers.pdf");
        ratio1->Print("GeometryRating_AngleDiff_LogEweight25-40Layers.C");
	...
	TLegend * l2= new TLegend(0.5,0.7,0.9,0.9);
        ...
        g1->GetYaxis()->SetRangeUser(0.0,0.7);
	...
	g8->Draw("P");
        ...
        comp1->Print("GeometryComparison_AngleDiff_LogEweight_25-40Layers.C");
        comp1->Print("GeometryComparison_AngleDiff_LogEweight_25-40Layers.pdf");
}
