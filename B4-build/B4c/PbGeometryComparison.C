...
//=========  (Fri Dec  8 15:35:34 2017) by ROOT version5.34/36
   ...
   Graph_Graph5->SetMinimum(0.03391762);
   Graph_Graph5->SetMaximum(0.3087421);
   ...
   Graph_Graph6->SetMinimum(0.02824587);
   Graph_Graph6->SetMaximum(0.5312752);
