...
//=========  (Wed Dec  6 09:02:45 2017) by ROOT version5.34/36
   ...
   rms->SetParameter(0,3.425793);
   rms->SetParError(0,0.03627917);
   rms->SetParLimits(0,0,0);
   rms->SetParameter(1,0.01995053);
   rms->SetParError(1,0.03649429);
   rms->SetParLimits(1,0,0);
   rms->SetParameter(2,0);
   rms->SetParError(2,0.0983996);
